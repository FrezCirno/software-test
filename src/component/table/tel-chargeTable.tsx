...
const columns = [
  {
    ...
    title: 'MonthTalkTime',
    dataIndex: 'monthTalkTime'
  }, {
    title: 'YearUnpaidNum',
    dataIndex: 'yearUnpaidNum'
  }, {
    title: 'UnpaidCostAcrossYear',
    dataIndex: 'unpaidCostAcrossYear'
  }, {
    title: 'PayMethod',
    dataIndex: 'payMethod'
  }, {
...
class ChargeTable extends React.Component {
    ...
    post({
      ...
      for (let i = 0; i < response.length; i++) {
        data.push({
          ...
          monthTalkTime: response[i].MonthTalkTime,
          yearUnpaidNum: response[i].YearUnpaidNum,
          unpaidCostAcrossYear: response[i].UnpaidCostAcrossYear,
          payMethod: response[i].PayMethod,
  ...
  render() {
    ...
    return (
      <div>
        <Dropdown overlay={menu} className={'dropdown_'}>
          <Button>
